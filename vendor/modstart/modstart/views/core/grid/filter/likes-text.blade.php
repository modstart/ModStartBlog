<div class="field" data-grid-filter-field="{{$id}}">
    ...
    <div class="input">
        ...
        <a href="javascript:;" class="ub-text-muted" data-like-add style="line-height:1.875rem;"><i class="iconfont icon-plus"></i></a>
    </div>
    <div data-input-template style="display:none;">
        <div style="display:inline-block;position:relative;">
            <a href="javascript:;" class="ub-text-muted" data-input-close style="position:absolute;width:1rem;font-size:0.625rem;line-height:1.625rem;text-align:center;top:0;right:0;">
